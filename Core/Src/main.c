...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : SR1020_CS_Pin */
  GPIO_InitStruct.Pin = SR1020_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(SR1020_CS_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : SR1020_RESET_Pin SR1020_SHDWN_Pin */
  GPIO_InitStruct.Pin = SR1020_RESET_Pin|SR1020_SHDWN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pin : SR1020_INT_Pin */
  GPIO_InitStruct.Pin = SR1020_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SR1020_INT_GPIO_Port, &GPIO_InitStruct);
