...
KEEP extern const touchgfx::GlyphNode glyphs_verdana_20_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE = {
    ...
    {   168, 0x0065,  10,  11,  11,   1,  12,   0,   0, 0x00 },
    {   223, 0x006A,   7,  18,  14,  -1,   7,   0,   0, 0x00 },
    {   295, 0x006F,  11,  11,  11,   1,  12,   0,   0, 0x00 },
    {   361, 0x0070,  11,  15,  11,   1,  12,   0,   0, 0x00 }
};
...
touchgfx::GeneratedFont& getFont_verdana_20_4bpp()
{
    static touchgfx::GeneratedFont verdana_20_4bpp(glyphs_verdana_20_4bpp, 7, 24, 20, 0, 0, 4, 1, 1, 0, unicodes_verdana_20_4bpp, kerning_verdana_20_4bpp, 63, 0, 0, 0);
